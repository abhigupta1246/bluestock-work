        ...
        <div className="w-full px-[15px]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-[10px] gap-y-[10px] w-full">
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-3 mb-6 sm:mb-10 text-left px-7">
              <div className="inline-block bg-yellow-400 px-4 py-2 mb-2 border-2" style={{ borderRadius: '15px', borderColor: '#fff' }}>
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight text-left m-0">Upcoming IPO</h1>
              </div>
              <p className="text-gray-700 text-sm sm:text-base text-left">Explore the latest upcoming IPOs. Stay up-to-date with fresh details including price bands, open/close dates, and more as disclosed by the companies listed.</p>
            </div>
            {ipoData.map((ipo, idx) => (
